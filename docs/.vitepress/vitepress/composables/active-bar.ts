...
export const useActiveSidebarLinks = (
    ...
    function deactivateLink(link: HTMLElement | null) {
...
const getAnchors = (sidebarLinks: HTMLAnchorElement[]) => {
    return (
        Array.from(
...
const getPageOffset = () => (document.querySelector('.navbar') as HTMLElement).offsetHeight;
