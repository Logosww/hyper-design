...
import { definePropType, buildProps } from '@hyper/utils';
...
export const usePopperContentProps = buildProps({
    ...
    pure: Boolean,
    popperClass: { type: definePropType<ClassType>([String, Array, Object]) },
    popperStyle: { type: definePropType<StyleValue>([String, Array, Object]) },
    referenceEl: { type:definePropType<HTMLElement>(Object) },
